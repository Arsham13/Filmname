...
<html lang="fa">
    <head>
        ...
        <style>
            ...
            main {
                background-image: url("34293830_blue_abstract_lines_2.svg");
                background-position: center;
                background-repeat: no-repeat;
        ...
        gap: 15px; */
            ...
            /* .gerdali {
                ...
                animation: rotation infinite ease-in-out 10s 1s;
            }
    ...
    <body>
        ...
        <img
            class="icons"
            style="rotate: 20deg; left: 9%; top: 16%; animation-duration: 3s"
            src="./icons8-movie-50.png"
            alt=""
        />
        <img
            class="icons"
            style="rotate: 20deg; right: 5%; top: 80%; animation-duration: 4s"
            src="./icons8-photo-gallery-50.png"
            alt=""
        />
