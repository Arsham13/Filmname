...
<body>
    ...
    <form action="login.php" method="post" id="form">
        <h1>فرم ورود</h1>
        <h5>
            لطفا اطلاعات خواسته شده را کامل کنید سپس دکمه ورود را فشار
            دهید
        </h5>
        ...
        <h5>
            حساب کاربری ندارید ؟ <a href="register_page.php">اینجا را کلیک کنید</a>
        </h5>
    </form>
    <script>
